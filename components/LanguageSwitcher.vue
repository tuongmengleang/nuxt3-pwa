  ...
  <div class="flex items-center">
    ...
    >
      ...
      <ListboxButton
        ...
        class="transition-colors duration-300 p-2 rounded-full bg-gray-100 dark:bg-gray-700 cursor-pointer"
      >
        <span
          class="justify-center items-center flex text-gray-800 dark:text-white"
        >
          <IconLa:language />
        </span>
      </ListboxButton>
